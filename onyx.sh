...
function usage {
  ...
  echo "      start          starts onyx-service, onyx-neurons, onyx-web and onyx-voice"
  echo "      stop           stops onyx-service, onyx-neurons, onyx-web and onyx-voice"
  echo "      restart        restart onyx-service, onyx-neurons, onyx-web and onyx-voice"
  echo
  echo "screen tips:"
  echo "            run 'screen -list' to see all running screens"
  echo "            run 'screen -r <screen-name>' (e.g. 'screen -r onyx-web') to reatach a screen"
